...
class SeedMigrator extends Migrator {
    ...
    {
        $filePath = base_path()."/".Config::get('smart-seeder::app.seedDir')."/".$file.".php";
        if (File::exists($filePath)) {
            require_once $filePath;
        } else if (!empty($this->repository->env)) {
            require_once base_path()."/".Config::get('smart-seeder::app.seedDir')."/".$this->repository->env."/".$file.".php";
        } else {
            require_once base_path()."/".Config::get('smart-seeder::app.seedDir')."/".App::environment()."/".$file.".php";
        }
